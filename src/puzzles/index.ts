...
// Import all puzzles
import basics01 from './01-basics/01-first-value'
import basics02 from './01-basics/02-double-it'
import basics03 from './01-basics/03-subtract'
...
export const LEVELS: Level[] = [
  {
    ...
    puzzles: [basics01, basics02, basics03]
  },
  {
    id: '02-context',
    title: 'Context',
